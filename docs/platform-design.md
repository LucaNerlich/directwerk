...
Companion documents drill into implementation, product strategy, and UI — read them before coding a slice.
...
| [poc-alpha-setup.md](poc-alpha-setup.md) | **Alpha POC blueprint** — vertical slices, auth, tenancy, module gates, HTTP harness | Implementation planning |
| [asset-storage.md](asset-storage.md) | S3 layout (Hetzner/Bunny EU), upload/confirm, `AssetAccessService`, group entitlements | Phase 2+; alpha storage foundation |
| [content-subscriptions-and-entitlements.md](content-subscriptions-and-entitlements.md) | **Operator guide** — FREE/PAID, LEVEL vs PACKAGE, grants, public vs private RSS | Creating public vs entitled content |
| [directwerk-studio.md](directwerk-studio.md) | Creator dashboard — audience, journeys, three-app model | Product / frontend planning |
| [directwerk-studio-implementation.md](directwerk-studio-implementation.md) | Studio implementation — screens, API mappings, scaffold, auth | Building `directwerk-studio` |
| [content-creation-implementation.md](content-creation-implementation.md) | Content backend — libraries, services, workflow engine | Backend + content editors |
| [content-platform-strategy.md](content-platform-strategy.md) | Publication platform vs CMS; blog/newsletter scope | Product scope for articles/email |
| [publication-desks-model.md](publication-desks-model.md) | Shared Publication rails + Writing vs Podcast desks | Studio UX / domain split |
| [ghost-positioning.md](ghost-positioning.md) | Competitive positioning vs Ghost | Sales, prioritization |
| [product-naming.md](product-naming.md) | Public product name strategy and naming history | Before public marketing |
...
| [README.md](README.md) | **Internal doc index** — what is current vs historical | Before editing or adding docs |
...
polish. Historical phase breakdown: [Implementation Checklist](#implementation-checklist) and
[`poc-alpha-setup.md` § Recommended work sequencepoc-alpha-setup.md#recommended-work-sequence).
...
[phase-2e-4-4b-implementation.md](phase-2e-4-4b-implementation.md) for what's shipped vs.
...
> [poc-alpha-setup.md](poc-alpha-setup.md). The sketch below uses `ModuleService` as a
...
[poc-alpha-setup § Module boundaries](boundariespoc-alpha-setup.md#module-boundaries-vertical-slices).
...
**Full specification:** [asset-storage.md](asset-storage.md) — providers, scopes,
per-asset entitlements, [module gatingasset-storage.md#module-gating),
[access control modelasset-storage.md#access-control-model), upload/confirm, error codes.
...
[directwerk-studio.md](directwerk-studio.md). Implementation guide (screens, scaffold, auth):
[directwerk-studio-implementation.md](directwerk-studio-implementation.md). Content backend
(libraries, workflow): [content-creation-implementation.md](content-creation-implementation.md).
...
**Alpha POC** uses a smaller set first — see [poc-alpha-setup § Database migrations](migrationspoc-alpha-setup.md#database-migrations-alpha)
...
See [asset-storage.md](asset-storage.md). Stripe webhook forwarding (when billing ships):
...
- [x] `Directwerk/compose.yaml` (Postgres + Mailpit), `Dockerfile`, [build-and-deploy.md](../Directwerk/docs/build-and-deploy.md), `AGENTS.md`
...
2. Configure `S3_*` env vars for Hetzner or Bunny dev bucket when working on uploads (see [asset-storage.md](asset-storage.md))
...
| [`directwerk-studio/`](../directwerk-studio/) | Default creator dashboard — see [directwerk-studio.md](directwerk-studio.md) |
| [`directwerk-web/`](../directwerk-web/) | Default public site + subscriber portal — agencies may replace |
| [ghost-positioning.md](ghost-positioning.md) | Competitive positioning vs Ghost — not a feature-parity target |
| [`AGENTS.md`](../AGENTS.md) | Monorepo conventions; independent subproject build |

---

*Last updated: 2026-08 — Stack: Spring Boot 4.1.0, Gradle 9.x, Flyway 12+, PostgreSQL 19 beta. Entry point: [`README.md`](../README.md). Run/deploy: [`Directwerk/docs/build-and-deploy.md`](../Directwerk/docs/build-and-deploy.md).*
