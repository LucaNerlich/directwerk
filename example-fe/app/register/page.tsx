...
export default function RegisterPage() {
    ...
    return (
        <AuthCard title="Register" description="Create an account for subscriber content." footer={<><span>Already registered? </span><Link className="underline" href="/login">Login</Link></>}>
