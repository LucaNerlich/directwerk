        ...
        <>
            <Form action={formAction} className="space-y-4">
                {tokenFromQuery.length > 0 ? (
                    ...
                    <div className="space-y-2"><Label htmlFor="token">Invite token</Label><Input id="token" name="token" type="text" autoComplete="off" maxLength={512} required /></div>
                )}
                ...
                <div className="space-y-2"><Label htmlFor="password">Password</Label><Input id="password" name="password" type="password" autoComplete="new-password" minLength={12} maxLength={128} required /></div>
            ...
            {state.success && (
                <Alert role="status"><AlertDescription>Invitation accepted. Redirecting to login…</AlertDescription></Alert>
            )}
        </>
    )
}
...
export default function AcceptInvitePage() {
    return (
        <AuthCard title="Accept invitation" footer={<Link className="underline" href="/login">Back to login</Link>}>
