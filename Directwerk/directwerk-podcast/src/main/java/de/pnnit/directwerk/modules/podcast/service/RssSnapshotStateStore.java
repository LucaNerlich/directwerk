...
/**
 * JDBC store for RSS snapshot presence and leftover slug prefixes.
 ...
 */
@Repository
public class RssSnapshotStateStore {

    static final long TENANT_SUBJECT_ID = 0L;

    private final JdbcTemplate jdbcTemplate;

    public RssSnapshotStateStore(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public boolean isWritten(Long tenantId, RssSnapshotKind kind, long subjectId) {
    ...
    public void markWritten(Long tenantId, RssSnapshotKind kind, long subjectId) {
        requireTenantId(tenantId);
        jdbcTemplate.update(
                """
    ...
    public void clearWritten(Long tenantId, RssSnapshotKind kind, long subjectId) {
        requireTenantId(tenantId);
        jdbcTemplate.update(
                """
