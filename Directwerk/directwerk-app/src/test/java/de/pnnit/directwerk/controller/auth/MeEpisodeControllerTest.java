...
class MeEpisodeControllerTest {
    ...
    void streamFreeEpisodeReturnsFoundRedirect() throws Exception {
        ...
        when(portalStreamDeliveryFacade.streamEpisode(principal, "episode-1", "alpha.example.test", null, null))
        ...
        verify(portalStreamDeliveryFacade).streamEpisode(principal, "episode-1", "alpha.example.test", null, null);
    }
