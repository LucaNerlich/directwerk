...
description: Operator guide for FREE/PAID content, LEVEL and PACKAGE products, and entitlement evaluation.
outline: deep
---

<!-- source: docs/content-subscriptions-and-entitlements.md -->
...
| **Related** | [Asset storage](/architecture/asset-storage) (bytes/CDN), modules UI in `directwerk-admin` |
